...
***Внимание!!! Вконтакте обновили классы UI, поэтому расширение и скрипт в настоящее время не работают. Исправьте целевые классы или механику взаимодействия с VK UI в коде продуктов самостоятельно или дождитесь официального релиза обновления нашего кода. 
С уважением, L.A.P.S.Lab***
